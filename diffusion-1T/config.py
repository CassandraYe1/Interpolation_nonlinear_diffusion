...
def init_config():
    ...
    """
    global D_ref, E_prev, E_ref, X, Y, Z, inp_fine, Z_fine, \
           X_coarse, Y_coarse, Z_coarse, inp_coarse, Z_coarse, D_coarse, E_coarse_prev, E_coarse_ref, \
           Xd, Yd, Zd, inp_d, Ed, Ed_, Dd, \
           Xl, Yl, Zl, inp_l, El, Dl, \
           Xr, Yr, Zr, inp_r, Er, Dr, \
           Xb, Yb, Zb, inp_b, Eb, Db, \
           Xt, Yt, Zt, inp_t, Et, Dt, _internal_initialized
